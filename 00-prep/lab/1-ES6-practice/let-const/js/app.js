...
function displayPics(){
  ...
  // Since rando is defined using let, and let is block scoped, it is scoped within the while loop, and not accessible outside of it.
...
if(localStorage.busmall){
  ...
  // var parsedArray = JSON.parse(localStorage.busmall);
  // allProducts = parsedArray;
  // I'm not sure why this throws an error, can't a globally scoped const assigned an object (array) have its value changed?
