...
// const Student = (name, age, hometown) => (new Student{
//   this.name = name;
// });
...
// The instance of Student that is named 'joe'

// 2. What is "this" when joe.scopeArrow() is invoked?
// The browser window. 

// 3. Explain why "this" is different when an arrow function is used.
// Because arrow function notation bubbles 'this' up to the next highest non-arrow object, which in this case is window. If it had been nested in another object that was defined using regular notation, 'this' would refer to that obeject and not the window.
